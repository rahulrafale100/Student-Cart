...
public class SellerLogin extends JFrame {
	...
	public SellerLogin(Sellers x) throws Exception{
		...
		lblNewLabel.setBounds(69, 84, 107, 36);
		contentPane.add(lblNewLabel);
		
		textField = new JTextField();
		textField.setBounds(230, 86, 170, 32);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Password");
		lblNewLabel_1.setFont(new Font("SansSerif", Font.PLAIN, 20));
		lblNewLabel_1.setBounds(69, 131, 107, 36);
...
String query="select * from users_details";
		...
		btnNewButton.setBounds(230, 206, 107, 32);
		contentPane.add(btnNewButton);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(230, 135, 170, 32);
		contentPane.add(passwordField);
		
		JLabel lblNewLabel_2 = new JLabel("Seller Login");
		lblNewLabel_2.setFont(new Font("Arial", Font.PLAIN, 25));
		lblNewLabel_2.setBounds(149, 26, 177, 32);
